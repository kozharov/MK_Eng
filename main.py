...
#############################################
        ...
        def q_word_label_font_size_determination():

            if len(word_list[secret_num[0]]) < 22:
                q_word_label.font_size = int(64*screen_coeff)
            elif len(word_list[secret_num[0]]) < 26:
                q_word_label.font_size = int(56*screen_coeff)
            elif len(word_list[secret_num[0]]) < 30:
                q_word_label.font_size = int(48*screen_coeff)
            elif len(word_list[secret_num[0]]) < 36:
                q_word_label.font_size = int(40*screen_coeff)
            elif len(word_list[secret_num[0]]) < 46:
                q_word_label.font_size = int(32*screen_coeff)
            elif len(word_list[secret_num[0]]) < 62:
                q_word_label.font_size = int(24*screen_coeff)
            elif len(word_list[secret_num[0]]) < 90:
                q_word_label.font_size = int(16*screen_coeff)
            else:
                q_word_label.font_size = 1


            
        def btn1_font_size_determination():

            if len(word_meaning[rand_num[0]]) < 22:
                btn1.font_size = 64
            elif len(word_meaning[rand_num[0]]) < 26:
                btn1.font_size = 56
            elif len(word_meaning[rand_num[0]]) < 30:
                btn1.font_size = 48
            elif len(word_meaning[rand_num[0]]) < 36:
                btn1.font_size = 40
            elif len(word_meaning[rand_num[0]]) < 46:
                btn1.font_size = 32
            elif len(word_meaning[rand_num[0]]) < 62:
                btn1.font_size = 24
            elif len(word_meaning[rand_num[0]]) < 90:
                btn1.font_size = 16
            else:
                btn1.font_size = 1
        ...
        def btn2_font_size_determination():

            if len(word_meaning[rand_num[1]]) < 22:
                btn2.font_size = 64
            elif len(word_meaning[rand_num[1]]) < 26:
                btn2.font_size = 56
            elif len(word_meaning[rand_num[1]]) < 30:
                btn2.font_size = 48
            elif len(word_meaning[rand_num[1]]) < 36:
                btn2.font_size = 40
            elif len(word_meaning[rand_num[1]]) < 46:
                btn2.font_size = 32
            elif len(word_meaning[rand_num[1]]) < 62:
                btn2.font_size = 24
            elif len(word_meaning[rand_num[1]]) < 90:
                btn2.font_size = 16
            else:
                btn2.font_size = 1
        ...
        def btn3_font_size_determination():

            if len(word_meaning[rand_num[2]]) < 22:
                btn3.font_size = 64
            elif len(word_meaning[rand_num[2]]) < 26:
                btn3.font_size = 56
            elif len(word_meaning[rand_num[2]]) < 30:
                btn3.font_size = 48
            elif len(word_meaning[rand_num[2]]) < 36:
                btn3.font_size = 40
            elif len(word_meaning[rand_num[2]]) < 46:
                btn3.font_size = 32
            elif len(word_meaning[rand_num[2]]) < 62:
                btn3.font_size = 24
            elif len(word_meaning[rand_num[2]]) < 90:
                btn3.font_size = 16
            else:
                btn3.font_size = 1
        ...
        def btn4_font_size_determination():

            if len(word_meaning[rand_num[3]]) < 22:
                btn4.font_size = 64
            elif len(word_meaning[rand_num[3]]) < 26:
                btn4.font_size = 56
            elif len(word_meaning[rand_num[3]]) < 30:
                btn4.font_size = 48
            elif len(word_meaning[rand_num[3]]) < 36:
                btn4.font_size = 40
            elif len(word_meaning[rand_num[3]]) < 46:
                btn4.font_size = 32
            elif len(word_meaning[rand_num[3]]) < 62:
                btn4.font_size = 24
            elif len(word_meaning[rand_num[3]]) < 90:
                btn4.font_size = 16
            else:
                btn4.font_size = 1
...
############################################
        ...
        def new_question( btn1_txt='Answer 1', btn2_txt='Answer 2', btn3_txt='Answer 3', btn4_txt='Answer 4'):
            ...
            q_word_label_font_size_determination()
            q_word_label.text = word_list[secret_num[0]] 

            btn1_font_size_determination()
            btn1.text = word_meaning[rand_num[0]] 


            btn2_font_size_determination()
            btn2.text = word_meaning[rand_num[1]]
            
            btn3_font_size_determination()
            btn3.text = word_meaning[rand_num[2]]
            
            btn4_font_size_determination()
